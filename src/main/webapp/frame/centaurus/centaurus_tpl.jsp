...
<link rel="stylesheet" type="text/css" href="<%=ContextPath%>/frame/centaurus/css/bootstrap/bootstrap.min.css"/>
 
<script src="<%=ContextPath%>/frame/centaurus/js/demo-rtl.js"></script>
...
<link rel="stylesheet" href="<%=ContextPath%>/frame/centaurus/css/libs/fullcalendar.print.css" type="text/css" media="print"/>
...
<script src="<%=ContextPath%>/frame/centaurus/js/jquery.js"></script>
<script src="<%=ContextPath%>/frame/centaurus/js/bootstrap.js"></script>
